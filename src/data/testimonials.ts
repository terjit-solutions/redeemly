...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    cityAr: "كيفه",
    cityFr: "Kiffa",
    comment: "Ordered a Steam gift card at 8pm, had the code by 8:15pm. My son was so happy! Will definitely use again.",
    commentAr: "طلبت بطاقة هدية ستيم الساعة 8 مساءً، وحصلت على الرمز الساعة 8:15. ابني كان سعيداً جداً! سأستخدمها مجدداً بالتأكيد.",
    commentFr: "J'ai commandé une carte Steam à 20h, j'avais le code à 20h15. Mon fils était tellement content !",
    service: "Steam Wallet",
    rating: 5,
    avatar: "MA",
  },
  {
