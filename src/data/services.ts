...
export const services: Service[] = [
  ...
  },
  {
    ...
    category: "gaming",
    brandColor: "#1B2838",
    brandColorLight: "#2a475e",
    description: "Add funds to your Steam wallet to purchase games, DLC, and in-game items.",
    descriptionAr: "أضف رصيداً لمحفظة ستيم لشراء الألعاب والإضافات والعناصر داخل اللعبة.",
    descriptionFr: "Ajoutez des fonds à votre portefeuille Steam pour acheter des jeux et contenus.",
    deliveryTime: "5-30 min",
    deliveryMethod: "Gift card code",
    deliveryMethodAr: "رمز بطاقة هدية",
    deliveryMethodFr: "Code carte cadeau",
    plans: [
      { id: "steam-10", name: "$10 Steam Card", nameAr: "بطاقة ستيم $10", nameFr: "Carte Steam 10$", priceUSD: 10, priceMRU: 390, duration: "One-time", durationAr: "مرة واحدة", durationFr: "Unique" },
      { id: "steam-20", name: "$20 Steam Card", nameAr: "بطاقة ستيم $20", nameFr: "Carte Steam 20$", priceUSD: 20, priceMRU: 780, duration: "One-time", durationAr: "مرة واحدة", durationFr: "Unique", popular: true },
      { id: "steam-50", name: "$50 Steam Card", nameAr: "بطاقة ستيم $50", nameFr: "Carte Steam 50$", priceUSD: 50, priceMRU: 1950, duration: "One-time", durationAr: "مرة واحدة", durationFr: "Unique" },
    ],
    rating: 4.9,
    reviewCount: 445,
    icon: "🎮",
